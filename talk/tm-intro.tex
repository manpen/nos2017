...
\begin{frame}{}
	\begin{center}
		...
		\large
		\only<2>{\includegraphics[height=0.7\textheight]{images/what-year-is-it.jpg}}
		\only<3-4>{%
			\only<3>{\includegraphics[height=0.6\textheight]{images/cumberbatch.jpg}}%
			\only<4>{\includegraphics[height=0.6\textheight]{images/turing.jpg}}%
			\hspace{2em}
