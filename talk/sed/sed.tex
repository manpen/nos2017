...
\begin{frame}{Strings und Regul\"are Ausdr\"ucke}
	...
	\hspace{5em}  \textit{\cA{h}\cB{a}\cC{ll}\cD{o} = ein \cA{h}, ein \cB{a}, zwei \cC{l} und ein \cD{o}}\\\pause
	\hspace{5em}  \textit{\cA{.}\cD{.}\cC{.} = \cA{irgendein Zeichen}, \cD{noch ein Zeichen} und \cC{noch ein Zeichen}}\\\pause
	\hspace{5em}  \textit{\cA{x*}\cB{y*} = erst \cA{viele x} und dann \cB{viele y}}\\\pause
	\hspace{5em}  \textit{\cA{hallo}\cD{.*} = \cA{hallo} und dann \cD{irgendwas}}\\ 
\end{frame}
